...
export const carportProducts: ProductItem[] = [
{
    ...
    description: "Metal carports for vehicle protection, outdoor parking and distributor projects. Supports custom size, roof panels, colors and installation packages.",
    image: "/images/slide-carport.webp",
    gallery: [
      "/images/slide-carport.webp",
