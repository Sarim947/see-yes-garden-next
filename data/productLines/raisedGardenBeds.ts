...
export const raisedGardenBedProducts: ProductItem[] = [
  {
    ...
    gallery: [
      ...
      `${rgb02AssetPath}/detail-carousel/02-garden-scene.webp`,
      `${rgb02AssetPath}/detail-carousel/03-garden-scene.webp`,
    ],
    // 可改：产品卡片下面的 3 个卖点会优先显示这里的前三项。
    highlights: ["Galvanized steel", "Modular and customizable sizes", "Durable, eco-friendly and safe"],
    // 可改：这些会影响左侧筛选统计。
    ...
    faqs: [
      ...
      [
        "Can I choose the color and material?",
        "Yes. Material, panel thickness, color and surface finish can be selected according to your market or project needs.",
      ],
      [
        "Do you support OEM packaging?",
        "Yes. We can support neutral cartons, branded labels, instruction sheets and retail packaging for bulk orders.",
      ],
      [
      ...
      [
        ...
        "Yes. We support residential, retail and landscape project supply with production coordination, packing and export delivery.",
      ],
    ],
