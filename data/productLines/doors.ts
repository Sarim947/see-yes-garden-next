...
export const doorProducts: DoorProduct[] = [
  {
    ...
    mobileCardImage: "/images/products/pivot-door/product-card/pivot-door-card-mobile.jpg",
    gallery: [
      {
      ...
      {
        desktop: "/images/products/pivot-door/detail-carousel/desktop/03-pivot-structure.webp",
